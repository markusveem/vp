<?php
  ...
  if($hournow >= 6 and $hournow < 8){
	  $partofday = "ärka üles ja sea sammud kooli poole";
  }
  ...
  if($hournow >= 22){
	  $partofday = "magama sättimine ja uneaeg";
  }
  ...
  if($fromsemesterstartdays > 0 and $fromsemesterstartdays < $semesterdurationdays){
	  ...
	  $semesterinfo = "Semester on täies hoos, kestab juba " .$fromsemesterstartdays ." päeva, läbitud on " .round ($semesterpercentage) ."%.";
  }
...
?>
  ...
  <p>Loo endale <a href="sisselogimine.php">kasutajakonto</a>!</p>
