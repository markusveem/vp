<?php
  ...
  if(isset($_POST["photosubmit"])){
	...
	//$myphoto->photofilecheck($photoFileTypes);
	...
	//$myphoto->filesizecheck($filesizelimit, $inputerror);
	...
	//$myphoto->filename($filenameprefix, $timestamp);
	$filename = $filenameprefix .$timestamp ."." .$filetype;

	//ega fail äkki olemas pole
	//$myphoto->doesfileexist($filename, $photouploaddir_orig)
	...
	if(empty($inputerror)){
		...
		$myphoto->moveorigimage($inputerror, $filename, $photouploaddir_orig);
