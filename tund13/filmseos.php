...
?>
  ...
  <input type="submit" name="filmstudiorelationsubmit" value="Salvesta filmi seos stuudioga "><span><?php echo $studionotice; ?></span>
  </form>
  ...
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<input type="submit" name="filmgenrerelationsubmit" value="Salvesta filmi žanri info"><span><?php echo $genrenotice; ?></span>
  </form>
