<?php
  ...
  setcookie("vpvisitorname", $_SESSION["userfirstname"] ." " .$_SESSION["userlastname"], time() + (86400 * 8), "/~markvee/", "greeny.cs.tlu.ee", isset($_SERVER["HTTPS"]), true);
  $lastvisitor = null;
...
?>
  ...
  <ul>
	...
	<li><a href="filmseos.php">Filmi seoste lisamine</a></li>
	<li><a href="addposition.php">Filmitegelased</a></li>
	...
	<li><a href="listnews.php">Uudiste toimetamine</a></li>
  </ul>
