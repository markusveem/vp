<?php
  ...
  SessionManager::sessionStart("vp", 0, "/~markvee/", "greeny.cs.tlu.ee");
  ...
  if($hournow >= 8 and $hournow < 18){
	  $partofday = "kooli toimetuste aeg";
  }
  if($hournow >= 18 and $hournow < 22){
	  $partofday = "vaba aeg loodetavasti";
  }
  if($hournow >= 22){
	  $partofday = "hea aeg et minna magama";
  }
  ...
  $latestpublicphotohtml = latestPicture(3);
